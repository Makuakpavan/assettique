    ...
    <PageLayout>
      ...
      <section className="section-padding pt-12 pb-8 bg-luxury-dark/20">
        ...
        >
          ...
          <h1 className="text-4xl md:text-6xl font-light mb-4">DISCOVER LAND</h1>
      ...
      <section className="section-padding py-4">
        <p className="text-sm text-luxury-muted">
          Showing <span className="text-luxury-ivory font-medium">{filteredProperties.length}</span> properties
      ...
      <section className="section-padding pb-24">
        {filteredProperties.length > 0 ? (
          ...
          <div className="text-center py-20">
            <p className="text-xl text-luxury-muted mb-4">NO PROPERTIES MATCHED YOUR SEARCH</p>
            <p className="text-sm text-luxury-muted/60 mb-6">Try adjusting your filters or search terms</p>
            <button 
              onClick={() => { setActiveCategory('All'); setSearchQuery(''); setPriceRange([0, 3000000000]); }}
